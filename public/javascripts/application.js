  ...
  $(document).ready(function() {
    ...
    $('.delete-image').click(function() {
      ...
      if (window.confirm('Es-tu sûre?')) {
        ...
        return $.ajax('/admin/photo/' + id + '/destroy', {
